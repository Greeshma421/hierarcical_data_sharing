...
import { Database, Brain, MessageSquare, Cpu, User } from 'lucide-react';
...
export function AnimatedBeamMultipleOutputDemo({
  ...
  return (
    <div
      className={cn(
        "relative items-center justify-center overflow-hidden rounded-lg border bg-background p-10 md:shadow-xl",
        className,
      )}
      ref={containerRef}
    >
      <div className="flex size-full flex-row items-stretch justify-between gap-10 max-w-lg">
        <div className="flex flex-col justify-center gap-2">
          <Circle ref={supabaseRef} className="text-blue-500">
            <Database />
          </Circle>
          <Circle ref={openaiRef} className="text-green-500">
            <Brain />
          </Circle>
          <Circle ref={geminiRef} className="text-purple-500">
            <Cpu />
          </Circle>
        </div>
        <div className="flex flex-col justify-center">
          <Circle ref={ragRef} className="size-16 text-orange-500">
            <MessageSquare />
          </Circle>
        </div>
        <div className="flex flex-col justify-center">
